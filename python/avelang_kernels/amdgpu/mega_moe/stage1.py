"""Run one destination-pool Stage1 tile per workgroup after push completes."""
...
def make_stage1(config):
    ...
    prefetch_input, read_input = make_mxfp4_packed_input(config, config.solution.hidden, ROW_BYTES, 17)
