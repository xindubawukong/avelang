...
from ..local_moe.stage2 import STAGE2_K256_LDS_WORDS, make_stage2_compute_k256
...
def make_stage2_tile(config):
    ...
    def run_stage2_tile(
        ...
        output = al.view(storage, al.u32, al.make_layout((32, 128), (128, 1)))
